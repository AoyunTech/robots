...
#### 1.1.1. Run the base driver:
    ...
    roslaunch ayspot_a0_config bringup.launch rviz:=true
...
#### 1.2.1. Run the Gazebo environment:
    ...
    roslaunch ayspot_a0_config gazebo.launch 

#### 1.2.2. Run gmapping package and move_base:

    roslaunch ayspot_a0_config slam.launch rviz:=true
...
#### 1.3.2. Run amcl and move_base:
    ...
    roslaunch ayspot_a0_config navigate.launch rviz:=true
...
Spawning a robot:
    ...
    roslaunch ayspot_a0_config spawn_robot.launch robot_name:=<unique_robot_name> world_init_x:=<x_position> world_init_y:=<y_position>
